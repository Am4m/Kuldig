        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @endphp
                    <!-- User Profile Link -->
                    <x-nav-link :href="route('profile.dashboard', $name)" :active="request()->routeIs('profile.dashboard')">
                        {{ $name }}
                    </x-nav-link>
                    
                    <!-- Projects Link -->
                    <x-nav-link :href="route('projects.view',$name)" :active="request()->routeIs('projects.view')">
                        {{ __('Projects') }}
                    </x-nav-link>
                </div>
            </div>
