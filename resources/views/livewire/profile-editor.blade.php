            ...
            <div class="border-t border-gray-700 pt-4"> 
                ...
                <div class="flex justify-around mt-4 pt-4 border-t border-gray-700">
                    <div class="text-center">
                        <span class="block text-lg font-bold text-white">{{ $user->followers_count ?? 0 }}</span>
                        <span class="text-xs text-gray-400">Followers</span>
                    </div>
                    <div class="text-center">
                        <span class="block text-lg font-bold text-white">{{ $user->following_count ?? 0 }}</span>
                        <span class="text-xs text-gray-400">Following</span>
                    </div>
                    <div class="text-center">
                        <span class="block text-lg font-bold text-white">{{ $user->projects_count ?? 0 }}</span>
