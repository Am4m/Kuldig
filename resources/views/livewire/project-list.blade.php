<div class="py-8">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl dark:shadow-blue-900/10 sm:rounded-lg mb-8 border dark:border-gray-700 transition-all duration-300 hover:shadow-lg dark:hover:shadow-blue-900/20">
            <div class="px-6 py-5 border-b dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex flex-wrap items-center gap-3">
                        @if($user->id === Auth::id())
                            <div>
                                <select wire:change="$set('filter', $event.target.value)" class="bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg pr-10 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition duration-200 ease-in-out">
                        ...
                        @endif
                        <div class="flex rounded-xl bg-white dark:bg-gray-800 shadow-lg p-1 max-w-fit">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="relative w-full sm:w-64 group">
                            ...
                            <input type="text"
                                ...
                                class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-sm placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm"
        ...
        <!-- Projects List -->
        <div class="bg-white dark:bg-gray-800 shadow-xl dark:shadow-blue-900/10 sm:rounded-lg border dark:border-gray-700 transition-all duration-300 hover:shadow-lg dark:hover:shadow-blue-900/20">
            <div class="px-6 py-4 border-b dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 flex items-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ count($projects) }} projects</h3>
            </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center flex-wrap gap-2">
                                <h4 class="text-lg font-medium text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors duration-300">
                                    <a href="#" class="flex items-center">
                                        {{ $project->name }}
                                    </a>
                                </h4>
                                <span class="px-2.5 py-0.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-full flex items-center shadow-inner">
                            ...
                            <div class="mt-4 flex flex-wrap items-center text-xs gap-4">
                                <span class="flex items-center text-gray-500 dark:text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                        ...
                        <div class="flex items-center space-x-4 ml-4">
                           @if($user->id === Auth::id())
                                ...
                                <button 
                                    ...
                                    class="p-2 rounded-full {{ $isPinned ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-500' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                               ...
                               <div x-data="{ open: false }" class="relative" @click.outside="open = false">
                                    <button @click="open = !open" class="w-8 h-8 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-all duration-300">
                                    ...
                                    <div x-show="open" x-cloak
                                        ...
                                        <button wire:click="openEditModal({{ $project->id }})" class="w-full text-left block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                                        ...
                                        <button wire:click="confirmDelete({{ $project->id }})" class="w-full text-left block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200">
                                            <div class="flex items-center">
    ...
    @if($showModal)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-50">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl transform transition-all max-w-lg w-full" 
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
                ...
                <form wire:submit="saveProject">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="projectName" wire:model="projectName" 
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-white transition-all duration-200">
                                @error('projectName') 
                            ...
                            <div>
                                ...
                                <textarea id="projectDescription" wire:model="projectDescription" rows="4" 
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-white transition-all duration-200"></textarea>
                            ...
                            <!-- Visibility Toggle -->
                            <div class="flex items-center">
                                <button type="button" class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 {{ $isPublic ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700' }}" role="switch" aria-checked="{{ $isPublic ? 'true' : 'false' }}" wire:click="$set('isPublic', {{ !$isPublic }})">
                                    <span class="sr-only">Use setting</span>
                                    <span aria-hidden="true" class="pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 {{ $isPublic ? 'translate-x-5' : 'translate-x-0' }}"></span>
                                </button>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900/30 px-6 py-4 flex justify-end space-x-3 border-t border-gray-200 dark:border-gray-700">
                        <button type="button" wire:click="closeModal" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                            Cancel
                        </button>
    ...
    @if($showDeleteConfirmation)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-50">
            <div x-show="open" class="bg-white dark:bg-gray-800 rounded-lg shadow-xl transform transition-all max-w-md w-full" 
                x-transition:enter="ease-out duration-300"
                x-transition:enter-start="opacity-0 scale-95"
                x-transition:enter-end="opacity-100 scale-100"
                x-transition:leave="ease-in duration-200" 
                ...
                <div class="bg-white dark:bg-gray-800 px-6 py-4 rounded-t-lg border-b dark:border-gray-700">
                    <div class="flex items-center justify-between">
                ...
                <div class="bg-gray-50 dark:bg-gray-900/30 px-6 py-4 flex justify-end space-x-3 rounded-b-lg border-t dark:border-gray-700">
                    <button type="button" wire:click="cancelDelete" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                        Cancel
                    </button>
